 ...
 * The following defintion is used for defining where the turtle should face at which degree(mathematical one):<br>
...
public interface ITurtleFX {
	 ...
	 * To use radians, look at the method "useRadians".
	 * 
	 ...
	 */
	abstract void useRadians(boolean useRadians);
	 ...
	 * Method to set the current position of the turtle on the canvas.
	 * 
	 * @param pos Desired position of the turtle as x and y coordinates
	 */
	...
	/**
	 * Method to get whether the pen is up or not.
	 * 
	 * @return Whether the pen is up or not
	 */
